(function($, undefined) {
	...
	jPlayerPlaylist.prototype = {
		...
		_createListItem: function(media) {
			...
			var listItem = "<li class='item'><div>";
			// Create remove control
			listItem += "<a href='javascript:;' class='" + this.options.playlistOptions.removeItemClass + "' style>&times;</a>";
			
             
			// The title is given next in the HTML otherwise the float:right on the free media corrupts in IE6/7
			listItem += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='1'>" +(media.album ?" <img class='thumb' src='"+media.album+"' title='"+media.title+"'/>":"")+"</a></div></li>";
			return listItem;
		},
		...
		_highlight: function(index) {
			if(this.playlist.length && index !== undefined) {
			    ...
			    $("#playing_img").html($(".jp-playlist-current")[1].innerHTML);
			}
		},
